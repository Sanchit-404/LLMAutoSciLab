...
def run_trial(args):
    ...
    (
        ...
        agent_backend,
        max_turns,
        max_experiment_turns,
        max_points_per_experiment_turn,
        max_total_query_points,
    ) = args
...
def run_experiment_for_version(cli_args, module, law_version, num_trials):
    ...
    pool_args = [
        (
            ...
            cli_args.model_name,
            cli_args.module,
            cli_args.equation_difficulty,
            cli_args.model_system,
            law_version,
            trials_dir,
            max_retries,
            judge_model_name,
            cli_args.agent_backend,
            cli_args.max_turns,
            cli_args.max_experiment_turns,
            cli_args.max_points_per_experiment_turn,
            cli_args.max_total_query_points,
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_turns", type=int, default=10, help="Maximum total interaction turns.")
    parser.add_argument("--max_experiment_turns", type=int, default=5, help="Maximum turns that may execute experiments.")
    parser.add_argument("--max_points_per_experiment_turn", type=int, default=4, help="Maximum query points executable in one experiment turn.")
    parser.add_argument("--max_total_query_points", type=int, default=20, help="Maximum total query points across the task.")
